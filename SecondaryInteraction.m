...
clear
% This vector sets the ratios that are evaluated.
% For example, the first ratio is 1:10, the second is 1:50, etc.
sub_kin_ratio = [10, 50, 100, 500, 1000];

for i = 1:length(sub_kin_ratio)
    % Evaluate the initial concentration of Kinase in uM
    kin = 20/sub_kin_ratio(i);
    ...
    title(strcat('Ratio of Phosphorylated Product to Total Substrate with a Kinase to Substrate ratio of 1:',num2str(sub_kin_ratio(i))))
